...
const picture = '/recipes/1.jpg';
const picTomato = '/recipes/2.jpg';
  ...
  <section className="grid grid-cols-1 lg:grid-cols-2">
    ...
    <div className="order-1">
      <div className="relative pb-2/3">
        <img src={picture} className="absolute w-full h-full object-cover rounded" />
      </div>
    </div>
  </section>
);
...
const RecipeActions = () => (
  <div className="flex justify-center px-6 py-2 mt-6 bg-white">
    <button className="inline-block px-4 py-1 mr-3">
    ...
    <button className="inline-block px-4 py-1">
